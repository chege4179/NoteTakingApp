...
class LocalNoteRepositoryTest  {
    private lateinit var db:NoteTakingAppDatabase
    private lateinit var localNoteRepository: LocalNoteRepository;
    ...
    @Test
    fun verify_db_is_empty_initially() = runTest {
        val items = localNoteRepository.getLocalNotes()
        items.test{
